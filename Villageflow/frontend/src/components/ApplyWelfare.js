...
function ApplyWelfare() {
    ...
    const loadUserApplications = useCallback(async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.get(`${API_BASE}/welfare/user-applications/${user._id}`);
    ...
    const handleApply = async (e) => {
        ...
        try {
            await axios.post(`${API_BASE}/welfare/apply`, formData, {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            await axios.put(`${API_BASE}/welfare/user-edit/${editingId}`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' }
            });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`${API_BASE}/welfare/user-delete/${id}`, {
            ...
            <div style={styles.container}>
                    ...
                    <form onSubmit={editingId ? handleEditSubmit : handleApply} style={styles.form}>
                        ...
                        {!editingId && (
                            <div style={styles.verifyBox}>
                                <ShieldCheck size={18} color="#8B0000" />
                ...
                <div style={styles.applicationsCard}>
                    <h3 style={styles.sectionTitle}>
                        <FileText size={20} color="#8B0000" /> {t.myApplications}
                    </h3>
