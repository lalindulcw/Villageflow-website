...
function VerifyCertificate() {
    ...
    if (loading) return (
        <div style={styles.center}>
            <Loader2 className="animate-spin" size={30} color="#8B0000" /> 
...
const styles = {
    ...
    retryBtn: { marginTop: '20px', padding: '12px 25px', border: 'none', background: '#8B0000', color: 'white', borderRadius: '8px', cursor: 'pointer', fontWeight: '600' },
