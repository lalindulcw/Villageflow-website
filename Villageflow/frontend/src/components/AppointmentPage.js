...
function AppointmentPage() {
    ...
    const fetchAppointments = useCallback(async () => {
        try {
            const res = await axios.get('https://villageflow.onrender.com/api/appointments/all');
    ...
    const loadConfig = async () => {
        try {
            ...
            if (publicConfig && publicConfig.appointment) {
                ...
                setMaxDays(days);
                const slotsRes = await axios.get('https://villageflow.onrender.com/api/appointments/available-slots');
    ...
    const handleUpdateSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://villageflow.onrender.com/api/appointments/update/${currentAppointmentId}`, updateFormData);
    ...
    const handleBook = async (e) => {
        ...
        try {
            ...
            await axios.post('https://villageflow.onrender.com/api/appointments/book', bookingData);
    ...
    const updateStatus = async (id, newStatus) => {
        try {
            await axios.put(`https://villageflow.onrender.com/api/appointments/status/${id}`, { status: newStatus });
    ...
    const deleteAppointment = async (id) => {
        if (window.confirm(t.deleteConfirm)) {
            try {
                await axios.delete(`https://villageflow.onrender.com/api/appointments/${id}`);
